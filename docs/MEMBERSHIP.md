...
| 8 | Тесты, `ml/tests/browser-membership.cjs`, документация | `dfba7aa` |
| + | Модель вашего вкуса (ML на устройстве), песочница, «угадай, потом попробуй», мини-проверки | `1fed373` и следующий |
